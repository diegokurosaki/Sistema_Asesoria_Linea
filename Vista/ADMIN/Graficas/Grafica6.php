...
if (isset($_POST['Fecha_Inicio'], $_POST['Fecha_Fin'], $_POST['IDEstudiante'])) {
    ...
    $stmt->bind_param("ssi", $fecha_inicio, $fecha_fin, $IDEstudiante);
    $stmt->execute();
    ...
    $data = array();
    $data[] = ['Mes', 'Total']; // Agregar la cabecera al array
    ...
    while ($fila = $resultado->fetch_assoc()) {
        $data[] = [$meses[(int)$fila['Mes']], (int)$fila['Total_Horas']];
    }
...
<div class="container mt-4">
    ...
    <div class="container mt-5">
        <form method="post" id="hacer_pdf" action="../../../Controlador/Reportes/Reportes_Conteo_Horas_Estudiante.php" enctype="multipart/form-data"> 
            ...
            <input type="hidden" name="IDEstudiante" id="IDEstudiante" value="<?php echo $IDEstudiante ?>">
