...
if (isset($_GET['id']) && !empty($_GET['id']) && isset($_GET['rol']) && !empty($_GET['rol'])) {
    ...
    $consulta = $conexion->prepare("SELECT D.Nombre_Usuario_D AS nombre_usuario, 
            D.Apellido_Paterno_D AS apellido_paterno, 
            D.Apellido_Materno_D AS apellido_materno, 
            D.Telefono_D AS telefono, 
            D.Fecha_Nacimiento_D AS fecha_nacimiento, 
            D.Genero_D AS genero, 
            D.Correo_electronico_D AS correo_electronico, 
            D.Contrasena_D AS contrasena,
            DM.Grado_academico AS grado_estudios,
            M.ID_Materia, 
            M.Nombre_Materia
            FROM 
                Docente D
            INNER JOIN 
                Docente_Materia DM ON D.ID_Usuario_D = DM.IdDocente
            INNER JOIN 
                Materias M ON DM.IdMateria = M.ID_Materia
            WHERE 
                D.ID_Usuario_D = ?;");
    ...
    <h2>Formulario de Usuario</h2>
        ...
        <input type="hidden" id="tipo_usuario" name="tipo_usuario" value="<?php echo $rol; ?>">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" value="<?php echo htmlspecialchars($row[0]['nombre_usuario'], ENT_QUOTES, 'UTF-8'); ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" value="<?php echo htmlspecialchars($row[0]['apellido_materno'], ENT_QUOTES, 'UTF-8'); ?>" required>
                <div class="invalid-feedback">
                    Por favor, ingresa tu Nombre.
                </div>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" value="<?php echo htmlspecialchars($row[0]['apellido_paterno'], ENT_QUOTES, 'UTF-8'); ?>" required>
                <div class="invalid-feedback">
                    Por favor, ingresa tu Nombre.
                </div>
            </div>
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php echo htmlspecialchars($row[0]['telefono'], ENT_QUOTES, 'UTF-8'); ?>" required>
                <div class="invalid-feedback">
                    Por favor, ingresa tu Nombre.
                </div>
            </div>
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo htmlspecialchars($row[0]['fecha_nacimiento'], ENT_QUOTES, 'UTF-8'); ?>" required>
                <div class="invalid-feedback">
                    Por favor, ingresa tu Nombre.
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="correo_electronico" name="correo_electronico" value="<?php echo htmlspecialchars($row[0]['correo_electronico'], ENT_QUOTES, 'UTF-8'); ?>" required>
                <div class="invalid-feedback">
                    Por favor, ingresa tu Nombre.
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="contrasena" name="contrasena" placeholder="Ingresa la contraseña" value="<?php echo htmlspecialchars($row[0]['contrasena'], ENT_QUOTES, 'UTF-8'); ?>" value="<?php echo $row['contrasena']; ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="valcontrasena" name="valcontrasena" value="<?php echo htmlspecialchars($row[0]['contrasena'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="Ingresa la contraseña" required>
                    <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="grado_estudios" name="grado_estudios" value="<?php echo htmlspecialchars($row[0]['grado_estudios'], ENT_QUOTES, 'UTF-8'); ?>">
                <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <select class="form-select" id="ID_Materia">
                    ...
                    <?php
                        $sql_tipos_materia = $conexion->query("SELECT * FROM Materias");
                        while ($resultado_tipo_materia = $sql_tipos_materia->fetch_assoc()) {
                            echo "<option value='" . htmlspecialchars($resultado_tipo_materia['ID_Materia'], ENT_QUOTES, 'UTF-8') . "'>" . htmlspecialchars($resultado_tipo_materia['Nombre_Materia'], ENT_QUOTES, 'UTF-8') . "</option>";
                        }
                    ?>
                </select>
                ...
                <tbody>
                    <?php
                        foreach ($row as $materia) {
                            echo "<tr>
                                <td>" . htmlspecialchars($materia['ID_Materia'], ENT_QUOTES, 'UTF-8') . "</td>
