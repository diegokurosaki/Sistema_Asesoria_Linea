...
try {
    ...
    $sql = "WITH TotalCitas AS (
                ...
                SELECT 
                    ...
                    ROUND((COUNT(*) / (SELECT TotalGlobal FROM TotalCitas)) * 100, 2) AS Porcentaje
                FROM 
                    Citas
                WHERE 
                    Fch_Cita BETWEEN ? AND ?
    ...
    if ($resultado->num_rows > 0) {
        ...
        $pdf->Cell(50, 7, "Total Topicos", 1, 0, "C", true);
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            $pdf->Cell(50, 7, $fila['Total_Topicos'], 1, 0, "C");
