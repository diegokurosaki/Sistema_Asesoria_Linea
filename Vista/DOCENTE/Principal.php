...
<html>
    ...
    <body> 
        ...
        <div class="contenedor"><!--LAS CARDS-->
            <a href="Documento.php" class="card"><!--INICIO PRIMERA CARD-->
            <div class="image"><span class="text"></span></div>
            <span class="title">Archivos compartidos</span>
            </a><!--FIN PRIMERA CARD-->
            <a href="Citas.php"class="card section2" ><!--INICIO SEGUNDA CARD-->
            <div class="image image2"><span class="text"></span></div>
            <span class="title">Evaluación Tópico</span>    
            </a><!--FIN SEGUNDA CARD-->
            <a href="Datos_Informacion.php"class="card section2" ><!--INICIO SEGUNDA CARD-->
