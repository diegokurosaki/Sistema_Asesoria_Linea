...
$sql = "SELECT 
            ...
            COUNT(ID_Estudiante_Citado) AS Total_Estudiantes
        FROM 
            Citas
        WHERE 
...
while ($fila = $resultado->fetch_assoc()) {
    $data[] = [$meses[(int)$fila['Mes']], (int)$fila['Total_Estudiantes']];
}
...
<head>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Total Estudiantes por Mes',
                is3D: true,
            };
...
<div class="container mt-4">
    ...
    <div class="container mt-5">
        <form method="post" id="hacer_pdf" action="../../../Controlador/Reportes/Reporte_Conteo_Citas.php" enctype="multipart/form-data"> 
